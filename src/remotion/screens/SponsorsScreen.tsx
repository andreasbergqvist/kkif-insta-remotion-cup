    ...
    <AbsoluteFill className="overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          `,
          backgroundSize:
            "150px 150px, 200px 200px, 100px 100px, 180px 180px, 120px 120px, 160px 160px, 140px 140px",
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full p-16">
        ...
        <div
          ...
          style={{
            ...
            textShadow:
              "3px 3px 0 rgba(0,0,0,0.7), 0 0 15px rgba(255,255,255,0.3)",
          }}
        >
        ...
        <div className="relative flex flex-col items-center justify-center space-y-6 z-10">
          {sponsors.map((sponsor, index) => {
            ...
            const wobbleX =
              Math.sin(
                (frame - (SPONSORS_START + index * SPONSOR_STAGGER)) / 40 +
                  index,
              ) * 3;
            const sponsorRotation =
              Math.sin(
                (frame - (SPONSORS_START + index * SPONSOR_STAGGER)) / 60 +
                  index,
              ) *
              (index % 2 === 0 ? 1 : -1) *
              0.8;
            const pulseScale =
              1 +
              Math.sin(
                (frame - (SPONSORS_START + index * SPONSOR_STAGGER)) / 80 +
                  index,
              ) *
                0.05;
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    textShadow:
                      "2px 2px 0 rgba(0,0,0,0.5), 0 0 20px rgba(255,255,255,0.4), 0 0 10px rgba(0, 95, 169, 0.6)",
